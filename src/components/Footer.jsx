              ...
              <div className="relative lg:flex lg:justify-center">
                ...
                <div className="flex items-center bg-[#0A0118] rounded-full shadow-[0_0_15px_5px_rgba(186,104,200,0.3)]">
                  <motion.input
                    ...
                    className="w-full text-center lg:w-64 bg-transparent text-white rounded-full py-2 px-4 focus:outline-none  "
                  ...
                  <motion.button
                    ...
                    className="bg-purple-500 hover:bg-purple-700 text-white rounded-full p-2 ml-2 transition-all duration-300"
